        		...
        		if(curpat instanceof patternLeafNode) { 
        			...
        			if(type == dataType.VAR) {
        				...
        				if(varList.lookUp(var) != null) {
                                           String prevVar = var;
        				   var = getTmpVar();
        				   listOfPredicates.addElement(Comparison.newComparison(opType.EQ,new Variable(var),new Variable(prevVar)));
        				}
        			} else {
        				...
        				// identifier
                                        StringConstant sc = new StringConstant((String) leafData.getValue());
        				var = getTmpVar();
