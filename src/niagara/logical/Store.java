...
/**
 * Store a parsed stream of documents into a local file, and register it as a
 * resource with the system catalog.
 */
public class Store extends UnaryOperator {
	...
	public void loadFromXML(Element e, LogicalProperty[] inputProperties,
		...
		root = Variable
				.findVariable(inputProperties[0], e.getAttribute("root"));
