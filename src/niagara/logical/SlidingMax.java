...
/**********************************************************************
  $Id: SlidingMax.java,v 1.1 2003/12/24 02:08:29 vpapad Exp $
...
public class SlidingMax extends SlidingWindow {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof SlidingMax)) return false;
        if (obj.getClass() != SlidingMax.class) return obj.equals(this);
