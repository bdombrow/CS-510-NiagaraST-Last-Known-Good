...
/**********************************************************************
  $Id: SlidingCount.java,v 1.1 2003/12/24 02:08:27 vpapad Exp $
...
public class SlidingCount extends SlidingWindow {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof SlidingCount)) return false;
        if (obj.getClass() != SlidingCount.class) return obj.equals(this);
