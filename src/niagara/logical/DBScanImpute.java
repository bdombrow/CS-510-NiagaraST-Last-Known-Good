// $Id: DBScanImpute.java,v 1.1 2008/10/21 23:11:38 rfernand Exp $

package niagara.logical;

/** Modified version of DBScan to support class example of imputation.*/
...
public class DBScanImpute extends NullaryOperator  {
    ...
    public DBScanImpute(DBScanSpec dbScanSpec, Attribute[] variables, SimilaritySpec sSpec, PrefetchSpec pfSpec) {
    ...
    public Op opCopy() {
        return new DBScanImpute((DBScanSpec) dbScanSpec, variables, sSpec, pfSpec);
    }

    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof DBScanImpute)) return false;
        if (obj.getClass() != DBScanImpute.class) return obj.equals(this);
