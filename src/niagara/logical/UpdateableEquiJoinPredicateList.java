...
public class UpdateableEquiJoinPredicateList extends EquiJoinPredicateList {
	...
	/**
	 * Remove unnecessary predicates, using an equivalence classes hashmap (and
	 * remove the corresponding entries from the hashmap)
	 */
	...
	public final boolean equals(Object other) {
		// XXX vpapad: made equals final, dealing with additional subclasses
		// will get
