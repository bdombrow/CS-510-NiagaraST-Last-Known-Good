/**********************************************************************
  $Id: Impute.java,v 1.1 2008/10/21 23:11:38 rfernand Exp $
...
/**
 * This class is used to represent the impute operator
...
public class Impute extends BinaryOperator {
    ...
    public Impute(Attribute pAttr, String timeAttr, PunctSpec pSpec, 
          String queryString) {
			this.pAttr = pAttr;
			this.pSpec = pSpec;
    ...
    public String toString() {
        ...
        strBuf.append("Impute: Punct: " + pSpec.toString() +
						          " Attr: " + pAttr.getName());
    ...
    public Op opCopy() {
        Impute other =  new Impute(this.pAttr, this.timeAttr, this.pSpec, this.queryString);
        other.setSPAttr(this.spAttr);
        return other;
    }

    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof Impute))
            return false;
        if (obj.getClass() != Impute.class)
            return obj.equals(this);
        Impute op = (Impute) obj;
