...
public abstract class PhysicalOp extends Op {
    ...
    private LogicalProperty logProp;
    ...
    public abstract Cost FindLocalCost(ICatalog catalog,
        LogicalProperty LocalLogProp,    // uses primarily the card of the Group
        LogicalProperty[] InputLogProp); //uses primarily cardinalities
    ...
    /** Initialize required fields from a logical operator */
    public abstract void initFrom(LogicalOp op);
