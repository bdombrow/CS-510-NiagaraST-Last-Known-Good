/* $Id: O_GROUP.java,v 1.3 2003/02/08 02:12:04 vpapad Exp $ */
    ...
    see search_circle in declaration of class Group, for notation
      ...
      Cases (3) and (4) remain.  More search.
        ...
        IF (Group is not optimized) 
          assert (this is case 3)
          if (property is ANY)
            add a winner for this context to the circle, 
            with null plan and infinite cost.
    ...
    public void perform() {
        ...
        if (!Group.isOptimized()) {
            ...
            if (LocalReqdProp.getOrder().isAny()) {
                ...
                //                    Cost eps_bound = new Cost(epsBound);
                //                    ssp.addTask(
                //                        new O_GROUP(ssp, GrpID, ContextID, ssp.TaskNo, true, eps_bound));
                //                } else
