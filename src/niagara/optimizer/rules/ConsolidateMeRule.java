...
/**
 * ConsolidateMeRule maps a non-consolidated operator to the ConsolidateMe
 * pseudo-physical operator, forcing Colombia to consolidate its inputs
 */
public class ConsolidateMeRule extends CustomRule {
	public ConsolidateMeRule(String name) {
		super(name, 0, new Expr(new AnyLogicalOp()) {
