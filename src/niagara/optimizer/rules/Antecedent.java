...
/**
 * Antecedent patterns for <code>ConstructedRule</code>s. A node in an
 * antecedent pattern is an operator, with an optional identifying name.
 */
...
public class Antecedent extends Pattern {
	 ...
	 * node in the pattern (e.g. [2, 3, 0] is the address of the 0th child of
	 * the 4th child of the 3rd child of the root)
	 */
