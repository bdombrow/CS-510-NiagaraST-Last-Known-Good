...
class XMLAuctionGenerator extends XMLFirehoseGen {
	...
	public XMLAuctionGenerator(String stFile, String desc2, int numTLElts,
			boolean streaming, boolean prettyPrint, Writer wrtTrace) {
		// this.stFile = stFile;
	...
	public void generatePerson(StringBuffer stb, int numPersons) {
		...
		// KT - if we need more speed - remove the pluses and also - to avoid
		// excessive
...
class Person {
	...
	private void genAddress() {
		...
		int icn = (m_rnd.nextInt(4) != 0) ? 0 : m_rnd
				.nextInt(ValueGen.countries.length);
		int ipv = (icn == 0) ? m_rnd.nextInt(ValueGen.provinces.length) : m_rnd
				.nextInt(ValueGen.lastnames.length);
	...
	private void genProfile(AuctionValues av) {
		if (m_rnd.nextBoolean())
			this.m_profile.m_stEducation = ValueGen.education[m_rnd
					.nextInt(ValueGen.education.length)];

		if (m_rnd.nextBoolean())
			this.m_profile.m_stGender = (m_rnd.nextBoolean()) ? "male"
					: "female";
...
class ValueGen {
	public static final String firstnames[] = { "Frederique", "Shigeichiro",
			"Xinan", "Takahira", "Rildo", "IEEE", "Weiru", "Nitsan", "Taiji",
			"Takahiro", "Zsolt", "Xiaoheng", "Toney", "Tru", "Nishit",
			"Gudjon", "Satoru", "Mohd", "Golgen", "Nidapan", "Lidong", "Serap",
			"Domenick", "Woody", "Ebbe", "Tse", "Domenico", "Zeydy", "Hidde",
			"Fumiko", "Sajjad", "Satosi", "Hitofumi", "Sibyl", "Mechthild",
			"Pramod", "Eishiro", "Demin", "Sajjan", "Jinpo", "Kazuyasu",
			"Lijia", "Branimir", "Lijie", "Moie", "Yoshimitsu", "Tsz",
			"Berhard", "Clyde", "Shakhar", "Moriyoshi", "Khedija", };

	public static final String lastnames[] = { "Wossner", "Gunderson", "Comte",
			"Linnainmaa", "Harbusch", "Speek", "Trachtenberg", "Kohling",
			"Speel", "Nollmann", "Jervis", "Capobianchi", "Murillo", "Speer",
			"Claffy", "Lalonde", "Nitta", "Servieres", "Chimia", "Boreale",
			"Taubenfeld", "Nitto", "Walston", "Danley", "Billawala",
			"Ratzlaff", "Penttonen", "Pashtan", "Iivonen", "Setlzner",
			"Reutenauer", "Hegner", "Demir", "Ramaiah", "Covnot", "Nitsch",
			"Thummel", "Axelband", "Sevcikova", "Shobatake", "Greibach",
			"Fujisaki", "Bugrara", "Dolinsky", "Dichev", "Versino",
			"Gluchowski", "Dahlbom", "Suri", "Parveen", "Businaro", "Taneja",
			"Morrey", "Siochi", "Alameldin", "Genin", "McAlpine", "Sury",
			"Angel", "Sambasivam", "Bazelow", "Demke", "Anger", "Brendel",
			"Cappelletti", "Walstra", "Hebden", "Carrera", "Brender",
			"Carrere", "Kalloufi", "Katzenelson", "Jeansoulin", "Renear",
			"Zuberek", "Snyers", };

	public static final String cities[] = { "Abidjan", "Abu", "Acapulco",
			"Aguascalientes", "Akron", "Albany", "Albuquerque", "Alexandria",
			"Allentown", "Amarillo", "Amsterdam", "Anchorage", "Appleton",
			"Aruba", "Asheville", "Athens", "Atlanta", "Augusta", "Austin",
			"Baltimore", "Bamako", "Bangor", "Barbados", "Barcelona", "Basel",
			"Baton", "Beaumont", "Berlin", "Bermuda", "Billings", "Birmingham",
			"Boise", "Bologna", "Boston", "Bozeman", "Brasilia", "Brunswick",
			"Brussels", "Bucharest", "Budapest", "Buffalo", "Butte", "Cairo",
			"Calgary", "Cancun", "Cape", "Caracas", "Casper", "Cedar",
			"Charleston", "Charlotte", "Charlottesville", "Chattanooga",
			"Chicago", "Chihuahua", "Cincinnati", "Ciudad", "Cleveland",
			"Cody", "Colorado", "Columbia", "Columbus", "Conakry",
			"Copenhagen", "Corpus", "Cozumel", "Dakar", "Dallas", "Dayton",
			"Daytona", "Denver", "Des", "Detroit", "Dothan", "Dubai", "Dublin",
			"Durango", "Durban", "Dusseldorf", "East", "El", "Elko",
			"Evansville", "Fairbanks", "Fayetteville", "Florence", "Fort",
			"Fortaleza", "Frankfurt", "Fresno", "Gainesville", "Geneva",
			"George", "Glasgow", "Gothenburg", "Grand", "Great", "Green",
			"Greensboro", "Greenville", "Grenada", "Guadalajara", "Guangzhou",
			"Guatemala", "Guaymas", "Gulfport", "Gunnison", "Hamburg",
			"Harrisburg", "Hartford", "Helena", "Hermosillo", "Honolulu",
			"Houston", "Huntington", "Huntsville", "Idaho", "Indianapolis",
			"Istanbul", "Jackson", "Jacksonville", "Johannesburg", "Kahului",
			"Kalamazoo", "Kalispell", "Kansas", "Key", "Kiev", "Killeen",
			"Knoxville", "La", "Lafayette", "Lansing", "Las", "Lawton", "Leon",
			"Lexington", "Lima", "Lisbon", "Little", "Lome", "London", "Long",
			"Lorient", "Los", "Louisville", "Lubbock", "Lynchburg", "Lyon",
			"Macon", "Madison", "Madrid", "Manchester", "Mazatlan",
			"Melbourne", "Memphis", "Merida", "Meridian", "Mexico", "Miami",
			"Milan", "Milwaukee", "Minneapolis", "Missoula", "Mobile",
			"Monroe", "Monterrey", "Montgomery", "Montreal", "Moscow",
			"Mulhouse", "Mumbai", "Munich", "Myrtle", "Nagoya", "Nashville",
			"Nassau", "New", "Newark", "Newburgh", "Newcastle", "Nice",
			"Norfolk", "Oakland", "Oklahoma", "Omaha", "Ontario", "Orange",
			"Orlando", "Ouagadougou", "Palm", "Panama", "Paris", "Pasco",
			"Pensacola", "Philadelphia", "Phoenix", "Pittsburgh", "Pocatello",
			"Port", "Portland", "Porto", "Prague", "Providence",
			"Providenciales", "Puebla", "Puerto", "Raleigh", "Rapid", "Reno",
			"Richmond", "Rio", "Roanoke", "Rochester", "Rome", "Sacramento",
			"Salt", "Salvador", "San", "Santiago", "Sao", "Sarasota",
			"Savannah", "Seattle", "Shannon", "Shreveport", "South", "Spokane",
			"St", "Stockholm", "Stuttgart", "Sun", "Syracuse", "Tallahassee",
			"Tampa", "Tapachula", "Texarkana", "Tokyo", "Toledo", "Toronto",
			"Torreon", "Toulouse", "Tri", "Tucson", "Tulsa", "Turin", "Twin",
			"Vail", "Valdosta", "Vancouver", "Venice", "Veracruz", "Vienna",
			"Villahermosa", "Warsaw", "Washington", "West", "White", "Wichita",
			"Wilkes", "Wilmington", "Windhoek", "Worcester", "Zihuatenejo",
			"Zurich" };

	public static final String countries[] = { "United States", "Afghanistan",
			...
			"Burkina Faso", "Burundi", "Cacos Islands", "Cambodia", "Cameroon",
			...
			"French Guiana", "French Polynesia", "French Southern Territory",
			"Futuna Islands", "Gabon", "Gambia", "Georgia", "Germany", "Ghana",
			...
			"Korea, Democratic People's Rep", "Korea, Republic Of", "Kuwait",
			"Kyrgyzstan", "Lao People's Democratic Republ", "Latvia",
			"Lebanon", "Lesotho", "Liberia", "Libyan Arab Jamahiriya",
			"Lithuania", "Luxembourg", "Macau", "Macedonia", "Madagascar",
			"Malawi", "Malaysia", "Maldives", "Mali", "Malta",
			"Marshall Islands", "Martinique", "Mauritania", "Mauritius",
			"Mayotte", "Mexico", "Micronesia", "Moldova, Republic Of",
			...
			"Russian Federation", "Rwanda", "Saint Kitts", "Samoa",
			"San Marino", "Sao Tome", "Saudi Arabia", "Senegal", "Seychelles",
			...
			"Svalbard and Jan Mayen Island", "Swaziland", "Sweden",
			"Switzerland", "Syrian Arab Republic", "Taiwan", "Tajikistan",
			"Tanzania", "Thailand", "Togo", "Tokelau", "Tonga", "Trinidad",
			"Tunisia", "Turkey", "Turkmenistan", "Turks Islands", "Tuvalu",
			"Uganda", "Ukraine", "United Arab Emirates", "United Kingdom",
			"Uruguay", "Us Minor Islands", "Us Virgin Islands", "Uzbekistan",
			"Vanuatu", "Vatican City State", "Venezuela", "Viet Nam",
			"Western Sahara", "Yemen", "Zaire", "Zambia", "Zimbabwe" };

	public static final String emails[] = { "ab.ca", "ac.at", "ac.be", "ac.jp",
			"ac.kr", "ac.uk", "acm.org", "airmail.net", "arizona.edu",
			"ask.com", "att.com", "auc.dk", "auth.gr", "baylor.edu",
			"bell-labs.com", "bellatlantic.net", "berkeley.edu",
			"brandeis.edu", "broadquest.com", "brown.edu", "cabofalso.com",
			"cas.cz", "clarkson.edu", "clustra.com", "cmu.edu", "cnr.it",
			"co.in", "co.jp", "cohera.com", "columbia.edu", "compaq.com",
			"computer.org", "concentric.net", "conclusivestrategies.com",
			"concordia.ca", "cornell.edu", "crossgain.com", "csufresno.edu",
			"cti.gr", "cwi.nl", "cwru.edu", "dauphine.fr", "dec.com", "du.edu",
			"duke.edu", "earthlink.net", "edu.au", "edu.cn", "edu.hk",
			"edu.sg", "emc.com", "ernet.in", "evergreen.edu",
			"fernuni-hagen.de", "filelmaker.com", "filemaker.com", "forth.gr",
			"forwiss.de", "fsu.edu", "gatech.edu", "gmu.edu", "gte.com",
			"hitachi.com", "hp.com", "ibm.com", "imag.fr", "indiana.edu",
			"infomix.com", "informix.com", "inria.fr", "intersys.com",
			"itc.it", "labs.com", "lante.com", "lbl.gov", "lehner.net",
			"llnl.gov", "lri.fr", "lucent.com", "memphis.edu", "microsoft.com",
			"mit.edu", "mitre.org", "monmouth.edu", "msn.com", "msstate.edu",
			"ncr.com", "neu.edu", "newpaltz.edu", "njit.edu", "nodak.edu",
			"ntua.gr", "nwu.edu", "nyu.edu", "ogi.edu", "okcu.edu",
			"oracle.com", "ou.edu", "panasonic.com", "pi.it", "pitt.edu",
			"poly.edu", "poznan.pl", "prc.com", "propel.com", "purdue.edu",
			"rice.edu", "rpi.edu", "rutgers.edu", "rwth-aachen.de",
			"savera.com", "sbphrd.com", "sds.no", "sdsc.edu", "sfu.ca",
			"sleepycat.com", "smu.edu", "solidtech.com", "stanford.edu",
			"sun.com", "sunysb.edu", "sybase.com", "telcordia.com",
			"temple.edu", "toronto.edu", "tue.nl", "twsu.edu", "ualberta.ca",
			"ubs.com", "ucd.ie", "ucdavis.edu", "ucf.edu", "ucla.edu",
			"ucr.edu", "ucsb.edu", "ucsd.edu", "ufl.edu", "uga.edu", "uic.edu",
			"uiuc.edu", "ul.pt", "umass.edu", "umb.edu", "umd.edu",
			"umich.edu", "umkc.edu", "unbc.ca", "unf.edu", "uni-freiburg.de",
			"uni-mannheim.de", "uni-marburg.de", "uni-mb.si",
			"uni-muenchen.de", "uni-muenster.de", "uni-sb.de", "uni-trier.de",
			"unical.it", "unizh.ch", "unl.edu", "upenn.edu", "uqam.ca",
			"uregina.ca", "usa.net", "ust.hk", "uta.edu", "utexas.edu",
			"uu.se", "uwaterloo.ca", "uwindsor.ca", "uwo.ca", "verity.com",
			"versata.com", "washington.edu", "whizbang.com", "wisc.edu",
			"wpi.edu", "yahoo.com", "yorku.ca", "zambeel.com" };

	public static final String provinces[] = { "Alabama", "Alaska", "Arizona",
	...
	public static final String education[] = { "High School", "College",
