...
public class NamedNodeMapImpl implements NamedNodeMap {
	...
	/**
	 * The only way anyone is ever going to get a NamedNodeMap out of SAXDOM is
	 * by calling Element.getAttributes() We use this fact to implement this
	 * class without any local storage.
	 */
