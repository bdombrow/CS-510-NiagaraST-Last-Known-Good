...
/**
 * Class <code>QPNodeFactory</code> is a registry for query plan node types.
 * 
...
public class QPNodeFactory {
	 ...
	 * 
	 * @return a new <code>QPNode</code>, or null if this element was not
	 *         recognized.
	 */
	public static QPNode parse(Element e, IDREFResolver idr, GraphModel gm) {
		...
		if (!names.containsKey(name))
			...
			try {
				...
				System.out.println("An appropriate instance of " + c.getName()
