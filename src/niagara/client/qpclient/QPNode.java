...
abstract public class QPNode implements Node, IDREFResolverClient {
	...
	pw.print("x=\"" + (int) (bounds.getX() + bounds.getWidth()/2) + "\" ");
	pw.print("y=\"" + (int) (bounds.getY() + bounds.getHeight()/2) + "\"");
    }
	...
	public QPFigure(QPNode qpn) {
        ...
        public void transform (AffineTransform at) {
            repaint();
            _bounds = (Rectangle2D.Float) CanvasUtilities.transform(_bounds, at);
            repaint();
        }
    }
