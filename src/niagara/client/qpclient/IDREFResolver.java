/**
 * <code>IDREFResolver</code> matches objects who want to become
 * identified with a particular IDREF, with client objects who want to be 
 * notified when a particular IDREF is resolved.
 *
...
public class IDREFResolver {
     ...
     *
     * @param idref a <code>String</code> value
     * @param o an <code>Object</code> value
     */
    public void addIDREF(String idref, Object o) {
	if (idrefs_to_clients.containsKey(idref)) {
	    ListIterator iter = 
		((ArrayList) idrefs_to_clients.get(idref)).listIterator();
	    while (iter.hasNext()) {
     ...
     *
     * @param idref a <code>String</code>
     * @param idc the <code>IDREFResolverClient</code> requesting registration
     */
