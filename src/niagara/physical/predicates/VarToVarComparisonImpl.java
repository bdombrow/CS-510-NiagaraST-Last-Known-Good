...
import niagara.logical.predicates.VarToVarComparison;
...
public class VarToVarComparisonImpl extends ComparisonImpl {
	 ...
	 * 
	 * @param tuples
	 *            The tuples on which the predicate is to be evaluated
	 * @param arithmeticPred
	 *            The arithmetic predicate to be evaluated
	 * 
	...
	public boolean evaluate(Node n) {
		throw new PEException(
				"A comparison between two variables needs at least two values!");
	}
