...
abstract public class ComparisonImpl implements PredicateImpl {
	 ...
	 * 
	 * @param leftValue
	 *            The left value for the equality comparison
	 * @param rightValue
	 *            The right value for the equality comparison
	 * 
...
/**
	...
	boolean stringGreaterThanEquals(String leftValue, String rightValue) {
		...
		return (stringEquals(leftValue, rightValue) || stringGreaterThan(
	...
	boolean stringLessThanEquals(String leftValue, String rightValue) {
		...
		return (stringEquals(leftValue, rightValue) || stringLessThan(
				leftValue, rightValue));
	}
	 ...
	 * @param rightValue
	 *            The string to find in the leftValue
	 * 
	...
	/**
	 * The numeric compare function is used to attempt to compare two strings as
	 * numeric double values
	 * 
	 * @param leftVal
	 *            The left string for the comparison
	 * @param rightVal
	 *            The right string for the comparison
	 * @param opCode
	...
	private boolean stringCompare(String leftValue, String rightValue) {
		...
		/**
		 * This function compares two atomic values. KT - atomic values are
		 * always strings.
		 * 
		 * @param leftValue
	...
	private boolean compare(BaseAttr leftVal, BaseAttr rightVal)
		...
		case opType.CONTAIN:
			throw new PEException(
					"BaseAttrs don't know what to do for the CONTAIN operator - Jenny");
		default:
			throw new PEException("Unknown operator for numeric comparison");
		}
	}
	...
	protected boolean compareAtomicValues(BaseAttr leftValue,
			BaseAttr rightValue) {
		// Check to see whether values exist
		if (leftValue == null || rightValue == null)
			throw new PEException("A null value passed for Comparison");
