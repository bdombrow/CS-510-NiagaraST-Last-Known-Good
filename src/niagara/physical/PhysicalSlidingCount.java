...
/**********************************************************************
  $Id: PhysicalSlidingCount.java,v 1.1 2003/12/24 01:49:01 vpapad Exp $
...
import niagara.logical.SlidingCount;
...
public class PhysicalSlidingCount extends PhysicalWindow {
	...
	countingAttribute = ((SlidingCount) logicalOperator).getCountingAttribute();

	// Get the range and every parameter of sliding window
	//
	super.range = ((SlidingCount) logicalOperator).getWindowRange();
	super.every = ((SlidingCount) logicalOperator).getWindowEvery();
    }
    ...
    public PhysicalGroup localCopy() {
        PhysicalSlidingCount op = new PhysicalSlidingCount();
	...
	PhysicalSlidingCount other = (PhysicalSlidingCount)o;
