...
/**********************************************************************
  $Id: PhysicalSlidingAverage.java,v 1.1 2003/12/24 01:49:02 vpapad Exp $
...
import niagara.logical.SlidingAverage;
...
public class PhysicalSlidingAverage extends PhysicalWindow {
	...
	averageAttribute = ((SlidingAverage) logicalOperator).getAveragingAttribute();
	
	// Get the range and every parameter of sliding window
	//
	super.range = ((SlidingAverage) logicalOperator).getWindowRange();
	super.every = ((SlidingAverage) logicalOperator).getWindowEvery();
    }
    ...
    protected PhysicalGroup localCopy() {
        PhysicalSlidingAverage op = 
	    new PhysicalSlidingAverage();
	...
	PhysicalSlidingAverage other = 
	    (PhysicalSlidingAverage)o;
