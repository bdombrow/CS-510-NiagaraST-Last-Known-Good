...
/**********************************************************************
  $Id: PhysicalSlidingMax.java,v 1.1 2003/12/24 01:49:03 vpapad Exp $
...
import niagara.logical.SlidingMax;
...
public class PhysicalSlidingMax extends PhysicalWindow {
	...
	maxingAttribute = ((SlidingMax) logicalOperator).getMaxingAttribute();
	
	// Get the range and every parameter of sliding window
	//
	super.range = ((SlidingMax) logicalOperator).getWindowRange();
	super.every = ((SlidingMax) logicalOperator).getWindowEvery();
    }
    ...
    protected PhysicalGroup localCopy() {
        PhysicalSlidingMax op = new PhysicalSlidingMax();
	...
	PhysicalSlidingMax other = (PhysicalSlidingMax)o;
