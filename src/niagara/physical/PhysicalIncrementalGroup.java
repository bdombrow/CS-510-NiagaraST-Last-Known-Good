/* $Id: PhysicalIncrementalGroup.java,v 1.1 2003/12/24 01:49:03 vpapad Exp $ */
...
public abstract class PhysicalIncrementalGroup extends PhysicalOperator {
    ...
    protected void processTuple(
        ...
        if (representativeTuple == null) {
            ...
            representativeTuple =
                new Tuple(true, groupAttrs.length + 2);
