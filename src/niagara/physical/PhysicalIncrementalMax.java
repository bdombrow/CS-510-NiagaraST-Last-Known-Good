...
public class PhysicalIncrementalMax extends PhysicalIncrementalGroup {
	...
	public void opInitFrom(LogicalOp logicalOperator) {
		...
		emptyGroupValue = ((IncrementalMax) logicalOperator)
				.getEmptyGroupValue();
	}
	...
	public Object processTuple(Tuple tuple, Object previousGroupInfo) {
		...
		try {
			...
			values.clear();
			Double newMax = new Double(Math.max(prevMax.doubleValue(), newValue
					.doubleValue()));
	...
	public boolean equals(Object o) {
		...
		return logicalGroupOperator
				.equals(((PhysicalIncrementalMax) o).logicalGroupOperator);
	}
