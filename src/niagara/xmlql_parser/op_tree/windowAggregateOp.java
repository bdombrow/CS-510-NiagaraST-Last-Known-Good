/**********************************************************************
  $Id: windowAggregateOp.java,v 1.1 2003/09/30 19:24:59 jinli Exp $
 ...
 *
 */
public abstract class windowAggregateOp extends windowGroupOp {

	// the attribute on which the aggregation function should
	// be performed
	protected Attribute aggrAttr;
	protected abstract windowAggregateOp getInstance();
	...
	if(!this.getClass().isInstance(obj)) 
		...
		windowAggregateOp other = (windowAggregateOp) obj;
