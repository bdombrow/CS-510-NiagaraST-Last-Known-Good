...
/**
 * Class <code> DateNodeHelper </code> which performs functions on two nodes,
 * interpreting the values as dates.
 * 
...
public class DateNodeHelper extends NumberNodeHelperBase implements
		NumberNodeHelper {
	...
	public Object valueOf(Node node) {
		/*
		 * don't really know what we should do for error checking here - just do
		 * this for now until I figure out something reasonable. This is ugly!!
		 */
		try {
