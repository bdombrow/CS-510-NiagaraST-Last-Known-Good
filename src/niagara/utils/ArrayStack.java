 ...
 * stack implemented using an array. Wrote this
 * because the ArrayList class from java is too slow.
 * The allocation of a ListIterator in the equals and hashCode
 * functions is too expensive!!
 *
 * @version 1.0
 *
...
public class ArrayStack {
	 ...
	 * the top of the stack (this is certainly what I want
	 * for the rooted key value stuff)
	 */
	for(int i = stackSize-1; i>= 0; i--) { 
	    if(!(stack[i] == null ? other.stack[i] == null :
		 stack[i].equals(other.stack[i]))) {
		return false;
	    }
	}
	return true;
