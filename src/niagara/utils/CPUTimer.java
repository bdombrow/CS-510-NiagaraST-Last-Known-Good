...
public class CPUTimer {
	...
	public void start() {
		assert !timerRunning : "Attempt to start timer when it is already running";
	...
	public void print(String msg) {
		...
		System.out
				.println(" Time: " + min + ":" + sec + df.format(ms / 1000.0));
		// + us/1000000.0 + ns/1000000000.0);
	}

	/*
	 * public static void main(String[] args) { Times t = new Times();
	 * t.times(); t.print("Initial"); int count = 0; for(int i = 0;
	 * i<1000000000; i++) { count +=i; } System.out.println("count " + count);
	 * t.times(); t.print("After count loop"); for(int i = 0; i<10000000; i++) {
	 * count +=i; } System.out.println("count " + count); t.times();
