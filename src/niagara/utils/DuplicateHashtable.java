...
public class DuplicateHashtable {
	...
	private class HashtableEntry {
		 ...
		 * 
		 * @param objectToAdd
		 *            The object to be added to the entry
		 */
		...
		/**
		 * This function removes an object from the list associated with this
		 * entry
		 * 
		 * @param objectToRemove
		 *            The object to remove from this entry
		 * 
	 ...
	 * 
	 * @return the list of values to which the key is mapped in this hashtable;
	...
	/**
	 * Removes the (key, object) pair from the hash table. This method does
	 * nothing if the key is not in the hashtable.
	 * 
	 * @param key
	 *            A key of the object to be removed
	 * @param objectToRemove
