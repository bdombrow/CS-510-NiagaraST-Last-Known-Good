...
/**********************************************************************
  $Id: LocalStream.java,v 1.1 2000/05/30 21:03:29 tufte Exp $
...
/**
 * The class <code>LocalStream</code> provides stream functionality that is used
 * for communicating between operators. It handles both data and control
 * elements. It is a direct descendant of the Stream class.
 *
 * @version 1.0
 *
 *
...
public class LocalStream extends Stream{
    ...
    public LocalStream(int upStreamBufferSize) {
