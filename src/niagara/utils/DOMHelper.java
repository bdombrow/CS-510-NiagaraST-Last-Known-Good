...
public class DOMHelper {
	...
	/**
	 * Returns the first child that is of type element. This and function below
	 * give the ability to iterate through the children of type element
	 * 
	 * @param parent
	 *            The parent whose children we will search and return
	 * 
	 ...
	 * 
	 * @param me
	 *            We find 'me's next sibling of type element.
	 * 
	...
	/**
	 * Returns all children with the specified tag name. This differs from
	 * getElementsByTagName in that it returns only children elements, not all
	 * descendent elements
	 * 
	 * @param parent
	 *            The parent whose children are to be searched
	 * @param tagName
	 *            The tag name to be used to select child elements
	 * 
	...
	public static ArrayList getChildElementsByTagName(Element parent,
		...
		/*
		 * iterate through the list and find the all the children with the given
		 * tag name
		 */
		while (child != null) {
	 ...
	 * 
	 * @param node
	 *            The element to return the child of
	 * 
	 ...
	 * 
	 * @param parent
	 *            The element whose children to search
	 * @param tagName
	...
	public static Element getFirstChildEltByTagName(Element parent,
		...
		/*
		 * iterate through the list and find the first child with the given tag
		 * name
		 */
