...
public class JProf {
	...
	System.out.println("Initial: " + JProf.getCurrentThreadCpuTime());
	int count = 0;
	...
	System.out.println("After count loop: " + JProf.getCurrentThreadCpuTime());
	//for(int i = 0; i<10000000; i++) {
	for(int i = 0; i<1000; i++) {
	    count +=i; 
	}
	System.out.println("count " + count);
	System.out.println("After 2nd count loop: " + JProf.getCurrentThreadCpuTime());
