...
/**********************************************************************
  $Id: PhysicalWindowAggregateOperator.java,v 1.1 2003/09/30 19:22:04 jinli Exp $
...
public abstract class PhysicalWindowAggregateOperator extends PhysicalWindowGroupOperator {

	Attribute aggrAttr;
	AtomicEvaluator ae;
	ArrayList atomicValues;

	protected abstract PhysicalWindowAggregateOperator getInstance();
	...
	protected void localInitFrom(LogicalOp logicalOperator) {
		aggrAttr = ((windowAggregateOp)logicalOperator).getAggrAttr();
	}
	...
	protected PhysicalGroupOperator localCopy() {
		PhysicalWindowAggregateOperator op = getInstance();
