...
/**
 * This is the <code>PhysicalWindowGroupOperator</code> that extends
...
public abstract class PhysicalWindowGroupOperator extends PhysicalGroupOperator {
	 ...
	 *                       seconds
	 */
	public PhysicalWindowGroupOperator() {
	...
	protected void localInitFrom(LogicalOp logicalOperator) {
		windowAttr = ((windowGroupOp)logicalOperator).getWindowAttr();
	}
