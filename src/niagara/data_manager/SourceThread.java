...
/**
 * The leaves of a physical operator tree, distinct from regular physical
 * operators. For the optimizer, a SourceThread is a regular physical operator.
 */
public abstract class SourceThread extends PhysicalOp implements Schedulable,
		Initializable, SchemaProducer, SerializableToXML, Instrumentable {
