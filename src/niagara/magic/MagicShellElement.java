...
public class MagicShellElement extends MagicBaseNode implements Node, Element,
		NodeList {
	...
	public Node cloneNode(boolean deep) throws DOMException {
		...
		/*
		 * Element clone = new MagicShellElement(this.tagName); for(int i = 0;
		 * i<numChildren; i++) clone.children[i] = children[i]; for(int i = 0;
		 * i<numAttrs; i++) clone.attrs[i] = attrs[i];
