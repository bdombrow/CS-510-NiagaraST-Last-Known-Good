 ...
 * this is an element with specified tag name and attribute and
 * content comes from another attribute in the tuple (attrIdx)
 */
...
public class MagicContentElement extends MagicNode {
    ...
    public MagicContentElement(int attrIdx, MagicBaseNode root, 
        		       String tagName) {
